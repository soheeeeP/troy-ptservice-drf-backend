...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tags', '0001_initial'),
        ('centers', '0002_alter_center_full_address'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trainer_profile', to='centers.center')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('body_info', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='trainee_profile', to='users.bodyinfo')),
