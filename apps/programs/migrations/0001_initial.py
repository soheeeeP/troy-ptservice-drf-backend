    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='programs.evaluation', verbose_name='평가')),
                ('goal', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='programs.goal', verbose_name='목표')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='programs.service', verbose_name='서비스')),
            ],
            options={
